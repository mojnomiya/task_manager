...
urlpatterns = [
    ...
    path('api/tasks/', api_views.TaskListCreateView.as_view(), name='task-list-create'),
    path('api/tasks/<int:pk>/', api_views.TaskRetrieveUpdateDeleteView.as_view(), name='task-retrieve-update-delete'),
